...
def load_and_merge():
    ...
    # ── OSMI Survey (DS1) ────────────────────────────────────────────────────
    df1 = pd.read_csv(r"C:\Users\Qasim Ashfaq\Desktop\D_SC\1) PROJECT FINAL DATA SCIENCE MENTAL HEALTH DIAGNOSIS\mindcheck_v3\survey.csv")
    ...
    df2 = pd.read_csv(r"C:\Users\Qasim Ashfaq\Desktop\D_SC\1) PROJECT FINAL DATA SCIENCE MENTAL HEALTH DIAGNOSIS\mindcheck_v3\Mental_Health_Dataset.csv")
...
COUNTRY_RESOURCES = {
    ...
    'India':       "Visit openwho.org or contact a local GP. The WHO Mental Health Atlas lists services globally.",
    'Other':          "For immediate mental health emergencies, call the Umang Pakistan 24/7 Helpline at 0311-7786264. For general medical emergencies, dial 1122 (Rescue 1122) nationwide.",
}
